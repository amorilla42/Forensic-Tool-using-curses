...
from curses_ui.system_artifacts_viewer import visualizar_artefactos_sistema
...
def artifact_menu(db_path, caso_dir):
    ...
    while True:
        ...
        menu = AwesomeMenu(title="Seleccione accion", options=["Archivos interesantes","Artefactos de usuarios","Artefactos del sistema" ], win=layout.body_win)
        ...
        if selected_option == 0:
            ...
            visualizar_artefactos_sistema(db_path)
